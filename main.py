...
"""We will write real practice RPG game."""


def attack(char_name: str, char_class: str) -> str:
    """We are writing an attack function by character classes."""
...
def defence(char_name: str, char_class: str) -> str:
    """We are writing an defence function by character classes."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """We are writing the special function by character classes."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Training selection function and gameplay."""
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        # Register the choice of a character
